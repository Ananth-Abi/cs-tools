...
// Config holds the connection settings for Consumer.
type Config struct {
	...
	// EntityPath suffix), not scoped to a single Event Hub.
	ConnectionString string
	// Topic is the Event Hub name (Kafka topic) to consume from.
	Topic string
}
