 ...
 * Service Request (digiops-cs#2818). Two steps: pick the target type, then
 * review what's retained/lost and fill in whatever the target needs. Only
 * Case <-> Engagement submits today — SRA/Service Request are still offered
 * on step 1 so the review step previews what transferring into them would
 * retain/lose, but the confirm button stays disabled until entity-service's
 * `caseType` validator (digiops-cs#2852) accepts them as targets.
 */
